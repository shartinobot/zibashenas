...
def check_easter_eggs(text: str) -> str:
    ...
    # 29. آشنایی (رمز جدید اضافه شده)
    if text == "آشنایی":
        return "🎵 دیدی وقتی یه آهنگ جدید میشنوی و تازه میفهمی از این لحظه به بعد، اون آهنگ مورد علاقته... چه حسی داره؟\n\nمن اولین باری که دیدمت، دقیقاً همون حس رو داشتم...\n\nفهمیدم از این به بعد، تو قراره آدم مورد علاقم بشی...\n\nو حالا هر روز، هر بار که میبینمت، انگار همون آهنگ رو برای اولین بار میشنوم! 🎶\n\nمهدی میگه آشنایی با غزل، بهترین آهنگی بود که توی زندگیم شنیدم! ❤️"
